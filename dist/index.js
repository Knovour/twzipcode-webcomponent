const W = globalThis, K = W.ShadowRoot && (W.ShadyCSS === void 0 || W.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, wt = /* @__PURE__ */ Symbol(), nt = /* @__PURE__ */ new WeakMap();
let At = class {
  constructor(t, i, s) {
...
const St = (e) => new At(typeof e == "string" ? e : e + "", void 0, wt), Ct = (e, t) => {
...
const { is: bt, defineProperty: Et, getOwnPropertyDescriptor: Pt, getOwnPropertyNames: Ot, getOwnPropertySymbols: zt, getPrototypeOf: xt } = Object, I = globalThis, rt = I.trustedTypes, Ht = rt ? rt.emptyScript : "", Lt = I.reactiveElementPolyfillSupport, U = (e, t) => e, Z = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ht : null;
      break;
  ...
  return i;
} }, tt = (e, t) => !bt(e, t), ht = { attribute: !0, type: String, converter: Z, reflect: !1, useDefault: !1, hasChanged: tt };
...
let P = class extends HTMLElement {
  ...
  static createProperty(t, i = ht) {
    if (i.state && (i.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((i = Object.create(i)).wrapped = !0), this.elementProperties.set(t, i), !i.noAccessor) {
      ...
      n !== void 0 && Et(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, i, s) {
    const { get: n, set: o } = Pt(this.prototype, t) ?? { get() {
      return this[i];
    }, set(r) {
      this[i] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(U("properties"))) {
      const i = this.properties, s = [...Ot(i), ...zt(i)];
...
P.elementStyles = [], P.shadowRootOptions = { mode: "open" }, P[U("elementProperties")] = /* @__PURE__ */ new Map(), P[U("finalized")] = /* @__PURE__ */ new Map(), Lt?.({ ReactiveElement: P }), (I.reactiveElementVersions ??= []).push("2.1.1");
const it = globalThis, J = it.trustedTypes, at = J ? J.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, yt = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, Tt = "?" + v, Ut = `<${Tt}>`, b = document, N = () => b.createComment(""), M = (e) => e === null || typeof e != "object" && typeof e != "function", et = Array.isArray, Nt = (e) => et(e) || typeof e?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ct = /-->/g, pt = />/g, S = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ut = /'/g, lt = /"/g, ft = /^(?:script|style|textarea|title)$/i, Mt = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), O = Mt(1), z = /* @__PURE__ */ Symbol.for("lit-noChange"), u = /* @__PURE__ */ Symbol.for("lit-nothing"), dt = /* @__PURE__ */ new WeakMap(), C = b.createTreeWalker(b, 129);
function Dt(e, t) {
...
const jt = (e, t) => {
  ...
  let n, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", r = L;
  for (let a = 0; a < i; a++) {
    const h = e[a];
    let p, l, c = -1, w = 0;
    for (; w < h.length && (r.lastIndex = w, l = r.exec(h), l !== null); ) w = r.lastIndex, r === L ? l[1] === "!--" ? r = ct : l[1] !== void 0 ? r = pt : l[2] !== void 0 ? (ft.test(l[2]) && (n = RegExp("</" + l[2], "g")), r = S) : l[3] !== void 0 && (r = S) : r === S ? l[0] === ">" ? (r = n ?? L, c = -1) : l[1] === void 0 ? c = -2 : (c = r.lastIndex - l[2].length, p = l[1], r = l[3] === void 0 ? S : l[3] === '"' ? lt : ut) : r === lt || r === ut ? r = S : r === ct || r === pt ? r = L : (r = S, n = void 0);
    const D = r === S && e[a + 1].startsWith("/>") ? " " : "";
    o += r === L ? h + Ut : c >= 0 ? (s.push(p), h.slice(0, c) + yt + h.slice(c) + v + D) : h + v + (c === -2 ? a : D);
  }
  return [Dt(e, o + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class j {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const a = t.length - 1, h = this.parts, [p, l] = jt(t, i);
    ...
    for (; (n = C.nextNode()) !== null && h.length < a; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const c of n.getAttributeNames()) if (c.endsWith(yt)) {
          const w = l[r++], D = n.getAttribute(c).split(v), B = /([.?@])?(.*)/.exec(w);
          h.push({ type: 1, index: o, name: B[2], strings: D, ctor: B[1] === "." ? Xt : B[1] === "?" ? Bt : B[1] === "@" ? Wt : q }), n.removeAttribute(c);
        } else c.startsWith(v) && (h.push({ type: 6, index: o }), n.removeAttribute(c));
        if (ft.test(n.tagName)) {
          const c = n.textContent.split(v), w = c.length - 1;
          if (w > 0) {
            n.textContent = J ? J.emptyScript : "";
            for (let D = 0; D < w; D++) n.append(c[D], N()), C.nextNode(), h.push({ type: 2, index: ++o });
            n.append(c[w], N());
          }
        }
      } else if (n.nodeType === 8) if (n.data === Tt) h.push({ type: 2, index: o });
      else {
        let c = -1;
...
class Rt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (r === h.index) {
        let p;
        h.type === 2 ? p = new R(o, o.nextSibling, this, t) : h.type === 1 ? p = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (p = new Zt(o, this, t)), this._$AV.push(p), h = s[++a];
      }
...
class R {
  ...
  _$AI(t, i = this) {
    t = x(this, t, i), M(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Nt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: i, _$litType$: s } = t, n = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = j.createElement(Dt(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === n) this._$AH.p(i);
    else {
      const o = new Rt(n, this), r = o.u(this.options);
      o.p(i), this.T(r), this._$AH = o;
    }
  }
  _$AC(t) {
    let i = dt.get(t.strings);
    return i === void 0 && dt.set(t.strings, i = new j(t)), i;
  }
  k(t) {
    et(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, n = 0;
    for (const o of t) n === i.length ? i.push(s = new R(this.O(N()), this.O(N()), this, this.options)) : s = i[n], s._$AI(o), n++;
...
class q {
  ...
  _$AI(t, i = this, s, n) {
    ...
    let r = !1;
    if (o === void 0) t = x(this, t, i, 0), r = !M(t) || t !== this._$AH && t !== z, r && (this._$AH = t);
    else {
      const a = t;
      let h, p;
      for (t = o[0], h = 0; h < o.length - 1; h++) p = x(this, a[s + h], i, h), p === z && (p = this._$AH[h]), r ||= !M(p) || p !== this._$AH[h], p === u ? t = u : t !== u && (t += (p ?? "") + o[h + 1]), this._$AH[h] = p;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Jt = it.litHtmlPolyfillSupport;
Jt?.(j, R), (it.litHtmlVersions ??= []).push("3.3.1");
const Yt = (e, t, i) => {
  const s = i?.renderBefore ?? t;
  let n = s._$litPart$;
  if (n === void 0) {
    const o = i?.renderBefore ?? null;
    s._$litPart$ = n = new R(t.insertBefore(N(), o), o, void 0, i ?? {});
  }
  return n._$AI(e), n;
};
const st = globalThis;
...
const Ft = st.litElementPolyfillSupport;
Ft?.({ LitElement: m });
...
const It = { attribute: !0, type: String, converter: Z, reflect: !1, hasChanged: tt }, qt = (e = It, t, i) => {
...
function d(e) {
  return (t, i) => typeof i == "object" ? qt(e, t, i) : ((s, n, o) => {
...
const Gt = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
function X(e, t) {
  return (i, s, n) => {
...
var Qt = Object.defineProperty, Vt = Object.getOwnPropertyDescriptor, A = (e, t, i, s) => {
  for (var n = s > 1 ? void 0 : s ? Vt(t, i) : t, o = e.length - 1, r; o >= 0; o--)
...
let y = class extends m {
  ...
  updated(e) {
    e.has("lang") && e.get("lang") && this.reload(), e.has("value") && this.dispatchEvent(
  ...
  reload() {
    this._counties = this.lang !== "en" ? Y : F, this._updateOptions();
  }
  ignore(e) {
    this._updateOptions(this.lang !== "en" ? e : e.map((t) => mt.get(t) ?? t));
  }
  findAndSelect(e, t) {
    this.select(e.find(({ zipcode: i }) => i.startsWith(t))?.county ?? "");
  }
  select(e) {
    this.value = e && this._options.includes(e) ? e : "", !this.value && this.$_select && (this.$_select.value = "");
  }
  _updateOptions(e = []) {
    this._options = e.length ? this._counties.filter((t) => !e.includes(t)) : this._counties, this.select(this.value);
  }
  _handleEvent(e) {
...
A([
  X("select")
], y.prototype, "$_select", 2);
y = A([
  G("county-field")
], y);
var Kt = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, T = (e, t, i, s) => {
...
let _ = class extends m {
  ...
  reload(e, t) {
    if (!t)
      return;
    let i = e.filter(({ county: s }) => s === t).map(({ district: s }) => s);
    if (t in this._ignoreList) {
      const s = this._ignoreList[t];
      i = i.filter((n) => !s?.includes(n));
    }
    this._options = i, this.select();
  }
  ignore(e) {
    let t = e.reduce((i, s) => ({ ...i, ...s }), {});
    this.lang === "en" && (t = Object.entries(t).reduce((i, [s, n]) => ({
      ...i,
      [mt.get(s) ?? s]: n.map((o) => kt.get(o) ?? o)
    }), {})), this._ignoreList = t;
  }
  findAndSelect(e, t) {
    const i = t.length === 3 ? e.find(({ zipcode: s }) => s === t)?.district ?? "" : "";
    this.select(i);
  }
  select(e = "") {
    this.value = e && this._options.includes(e) ? e : "", this.value || (this.$_select.value = "");
  }
  _handleEvent(e) {
    this.select(e.target.value);
  }
...
T([
  g()
], _.prototype, "_ignoreList", 2);
T([
  g()
], _.prototype, "_options", 2);
T([
  X("select")
], _.prototype, "$_select", 2);
_ = T([
  G("district-field")
], _);
const ii = [
...
var ni = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, f = (e, t, i, s) => {
...
let $ = class extends m {
  constructor() {
    super(...arguments), this.lang = "zh-tw", this._data = $t, this.value = { zipcode: void 0, county: void 0, district: void 0 }, this._countyUpdateHandler = this._handleCountyUpdate.bind(this), this._districtUpdateHandler = this._handleDistrictUpdate.bind(this), this._zipcodeUpdateHandler = this._handleZipcodeUpdate.bind(this);
  }
  attributeChangedCallback(e, t, i) {
    t !== i && requestAnimationFrame(() => {
      switch (e) {
        case "lang":
          this._data = i !== "en" ? $t : ei, [this.$_zipcode, this.$_county, this.$_district].forEach((s) => {
            s && (s.lang = i);
          });
          break;
        case "default-values":
          this._writeDefaultValues(i);
          break;
        case "ignore-options":
          this._updateIgnoreOpts(i);
      }
    });
  }
  connectedCallback() {
  ...
  updated(e) {
    e.has("_data") && this.$_county?.reload(), e.has("value") && this._dispatch(this.value);
  }
  _writeDefaultValues(e) {
    const { zipcode: t, county: i, district: s } = this._parseJSON(e, {});
    this._data.some(({ zipcode: n, county: o, district: r }) => n === t && o === i && r === s) && (this.$_zipcode?.write(t), this.$_county?.select(i), requestAnimationFrame(() => this.$_district?.select(s)));
  }
  _updateIgnoreOpts(e) {
    const t = this._parseJSON(e, []), { c: i = [], d: s = [] } = Object.groupBy(t, (n) => typeof n == "string" ? "c" : "d");
    this.$_county?.ignore(i), this.$_district?.ignore(s);
  }
  _parseJSON(e, t) {
    try {
      return JSON.parse(e) ?? t;
    } catch (i) {
      return console.warn("Failed to parse JSON:", e, i), t;
    }
  }
  _handleZipcodeUpdate(e) {
    this._updateValue("zipcode", e);
  }
  _handleCountyUpdate(e) {
    const t = this._updateValue("county", e);
    this.$_district?.reload(this._data, t);
  }
  _handleDistrictUpdate(e) {
    const t = this._updateValue("district", e);
    this.$_zipcode?.findAndWrite(this._data, { county: this.value.county, district: t });
  }
  _updateValue(e, { detail: t }) {
    return this.value = { ...this.value, [e]: t.value }, t.value;
  }
  _dispatch(e) {
    if (Object.values(e).some((i) => !i))
      return;
    this._data.some(({ zipcode: i, county: s, district: n }) => i === e.zipcode && s === e.county && n === e.district) && this.dispatchEvent(new CustomEvent("done", { detail: { value: e } }));
  }
  createRenderRoot() {
    return this;
  }
...
f([
  d({ type: Object, attribute: "default-values" })
], $.prototype, "defaultValues", 2);
f([
  d({ type: Array, attribute: "ignore-options" })
], $.prototype, "ignoreOptions", 2);
f([
  g()
], $.prototype, "_data", 2);
f([
...
f([
  X("zipcode-field")
], $.prototype, "$_zipcode", 2);
f([
  X("county-field")
], $.prototype, "$_county", 2);
f([
  X("district-field")
], $.prototype, "$_district", 2);
$ = f([
  G("twzipcode-fieldset")
], $);
var ri = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, H = (e, t, i, s) => {
...
let E = class extends m {
  ...
  findAndWrite(e, t) {
    const i = e.find(({ county: s, district: n }) => s === t.county && n === t.district)?.zipcode ?? "";
    this.write(i);
  }
  write(e) {
    this.value = e;
