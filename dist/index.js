...
const vt = (e) => new Dt(typeof e == "string" ? e : e + "", void 0, yt), mt = (e, t) => {
...
const { is: At, defineProperty: Ct, getOwnPropertyDescriptor: St, getOwnPropertyNames: bt, getOwnPropertySymbols: Et, getPrototypeOf: Ot } = Object, I = globalThis, rt = I.trustedTypes, Pt = rt ? rt.emptyScript : "", zt = I.reactiveElementPolyfillSupport, H = (e, t) => e, Z = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Pt : null;
      break;
  ...
  return i;
} }, tt = (e, t) => !At(e, t), ht = { attribute: !0, type: String, converter: Z, reflect: !1, useDefault: !1, hasChanged: tt };
...
let E = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(H("properties"))) {
      const i = this.properties, s = [...bt(i), ...Et(i)];
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[H("elementProperties")] = /* @__PURE__ */ new Map(), E[H("finalized")] = /* @__PURE__ */ new Map(), zt?.({ ReactiveElement: E }), (I.reactiveElementVersions ??= []).push("2.1.1");
const it = globalThis, Y = it.trustedTypes, at = Y ? Y.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, $t = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + v, xt = `<${wt}>`, S = document, L = () => S.createComment(""), M = (e) => e === null || typeof e != "object" && typeof e != "function", et = Array.isArray, Ut = (e) => et(e) || typeof e?.[Symbol.iterator] == "function", V = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ct = /-->/g, pt = />/g, A = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), lt = /'/g, ut = /"/g, _t = /^(?:script|style|textarea|title)$/i, Ht = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), O = Ht(1), P = /* @__PURE__ */ Symbol.for("lit-noChange"), u = /* @__PURE__ */ Symbol.for("lit-nothing"), dt = /* @__PURE__ */ new WeakMap(), C = S.createTreeWalker(S, 129);
function ft(e, t) {
...
const Lt = (e, t) => {
  ...
  for (let a = 0; a < i; a++) {
    const h = e[a];
    let l, d, c = -1, f = 0;
    for (; f < h.length && (r.lastIndex = f, d = r.exec(h), d !== null); ) f = r.lastIndex, r === U ? d[1] === "!--" ? r = ct : d[1] !== void 0 ? r = pt : d[2] !== void 0 ? (_t.test(d[2]) && (n = RegExp("</" + d[2], "g")), r = A) : d[3] !== void 0 && (r = A) : r === A ? d[0] === ">" ? (r = n ?? U, c = -1) : d[1] === void 0 ? c = -2 : (c = r.lastIndex - d[2].length, l = d[1], r = d[3] === void 0 ? A : d[3] === '"' ? ut : lt) : r === ut || r === lt ? r = A : r === ct || r === pt ? r = U : (r = A, n = void 0);
    const D = r === A && e[a + 1].startsWith("/>") ? " " : "";
    o += r === U ? h + xt : c >= 0 ? (s.push(l), h.slice(0, c) + $t + h.slice(c) + v + D) : h + v + (c === -2 ? a : D);
  }
...
class N {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const a = t.length - 1, h = this.parts, [l, d] = Lt(t, i);
    ...
    for (; (n = C.nextNode()) !== null && h.length < a; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const c of n.getAttributeNames()) if (c.endsWith($t)) {
          ...
          h.push({ type: 1, index: o, name: B[2], strings: D, ctor: B[1] === "." ? Nt : B[1] === "?" ? jt : B[1] === "@" ? Rt : q }), n.removeAttribute(c);
...
class Mt {
  ...
  u(t) {
    const { el: { content: i }, parts: s } = this._$AD, n = (t?.creationScope ?? S).importNode(i, !0);
    C.currentNode = n;
    let o = C.nextNode(), r = 0, a = 0, h = s[0];
    for (; h !== void 0; ) {
      if (r === h.index) {
        let l;
        h.type === 2 ? l = new j(o, o.nextSibling, this, t) : h.type === 1 ? l = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (l = new Xt(o, this, t)), this._$AV.push(l), h = s[++a];
      }
      r !== h?.index && (o = C.nextNode(), r++);
    }
    return C.currentNode = S, n;
  }
  p(t) {
    let i = 0;
...
class j {
  ...
  _$AI(t, i = this) {
    t = z(this, t, i), M(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== P && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ut(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
const Bt = it.litHtmlPolyfillSupport;
Bt?.(N, j), (it.litHtmlVersions ??= []).push("3.3.1");
const Wt = (e, t, i) => {
...
const Yt = { attribute: !0, type: String, converter: Z, reflect: !1, hasChanged: tt }, Jt = (e = Yt, t, i) => {
...
const Ft = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
function X(e, t) {
  return (i, s, n) => {
...
let w = class extends m {
  ...
  _updateOptions() {
    const e = this.lang !== "en" ? J : F, t = this.lang !== "en" ? this.ignoreOptions : this.ignoreOptions.map((i) => Gt.get(i) ?? i);
...
var Kt = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, _ = (e, t, i, s) => {
...
let y = class extends m {
  constructor() {
    super(...arguments), this.classes = "", this.name = "district", this.placeholder = "---", this.lang = "zh-tw", this.value = "", this.districts = [], this.ignoreOptions = [], this._options = [];
  }
  willUpdate(e) {
    (e.has("districts") || e.has("ignoreOptions")) && (this._updateOptions(), this._select(this.value));
  }
  updated(e) {
    e.has("value") && this.dispatchEvent(
  ...
  _updateOptions() {
    const e = this.lang !== "en" ? this.ignoreOptions : this.ignoreOptions.map((t) => Vt.get(t) ?? t);
    this._options = this.districts.filter((t) => !e.includes(t));
  }
  _handleEvent(e) {
    this._select(e.target.value);
  }
...
_([
  p({ type: Array, attribute: !1 })
], y.prototype, "districts", 2);
_([
  p({ type: Array, attribute: !1 })
], y.prototype, "ignoreOptions", 2);
_([
  R()
...
var ni = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, $ = (e, t, i, s) => {
...
let g = class extends m {
  ...
  willUpdate(e) {
    if (e.has("lang") && (this._data = this.lang !== "en" ? gt : ei, [this.$_zipcode, this.$_county, this.$_district].forEach((t) => {
      t && (t.lang = this.lang);
  ...
  _syncChildren() {
    this.$_zipcode && (this.$_zipcode.value = this.value.zipcode ?? ""), this.$_county && (this.$_county.value = this.value.county ?? "", this.$_county.ignoreOptions = this.ignoreCounties), this.$_district && (this.$_district.value = this.value.district ?? "", this.$_district.districts = this.value.county ? this._data.filter(({ county: e }) => e === this.value.county).map(({ district: e }) => e) : [], this.$_district.ignoreOptions = this.value.county ? this.ignoreDistricts[this.value.county] ?? [] : []);
  }
...
], g.prototype, "defaultValues", 2);
$([
  p({ type: Array, attribute: "ignore-counties" })
], g.prototype, "ignoreCounties", 2);
$([
  p({ type: Object, attribute: "ignore-districts" })
], g.prototype, "ignoreDistricts", 2);
$([
  R()
], g.prototype, "_data", 2);
$([
...
$([
  R()
], g.prototype, "_lastValue", 2);
$([
  X("zipcode-field")
], g.prototype, "$_zipcode", 2);
$([
  X("county-field")
], g.prototype, "$_county", 2);
$([
  X("district-field")
], g.prototype, "$_district", 2);
g = $([
