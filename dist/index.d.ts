...
declare type County = (typeof zhCountyList)[number] | (typeof enCountyList)[number];

export declare class CountyField extends LitElement {
    classes: string;
    name: string;
    placeholder: string;
    lang: Lang;
...
declare type District = (typeof zhDistrictList)[number] | (typeof enDistrictList)[number];

export declare class DistrictField extends LitElement {
    classes: string;
    name: string;
    placeholder: string;
    lang: Lang;
